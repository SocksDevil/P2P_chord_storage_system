...
public class Constants {
    ...
    public static final int  MAX_OCCUPIED_DISK_SPACE_MB = 6 * MEGABYTE; // SIZE IN MB
    public static final int BLOCK_SIZE  = 2 * MEGABYTE; // Size in MB, TODO: decide a better size
