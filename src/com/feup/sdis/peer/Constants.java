...
public class Constants {
    ...
    public static int MAX_OCCUPIED_DISK_SPACE = 6 * MEGABYTE; // SIZE IN MB
    public static final int BLOCK_SIZE  = 1  * MEGABYTE; // Size in MB
    ...
    public static final int REQUEST_RETRY_INTERVAL_MS = 10000;
